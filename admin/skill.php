...
if(isset($_GET['delete'])){
  ...
  header("location:app.php?page=skill&hapus=berhasil");
}
                    ...
                    <tb>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          href="app.php?page=create-skill&edit=<?php echo $row['id']?>
                          ">Edit </a>
                          
                          <a onclick="return confirm('Are you sure wanna delete this data?')" class="btn btn-danger btn-sm"
                          href="app.php?page=skill&delete=<?php echo $row['id']?>">Delete</a>
                        </td>
                      </tr>
                      <?php endforeach ?> 
                    </tb>
