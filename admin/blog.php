...
$query = mysqli_query($conn, "SELECT * FROM blog ORDER BY id DESC"); //* ALL asc kecil ke besar 
...
if(isset($_GET['delete'])){
  ...
  $rowImg = mysqli_fetch_assoc($img);
    ...
    header("location:app.php?page=bloghapus=berhasil");
}
...
?>
          <div
            ...
            <div>
              <h3 class="fw-bold mb-3">My Blog</h3>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
              <!-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> -->
              <a href="app.php?page=create-blog" class="btn btn-primary btn-round">Create New Blog</a>
            </div>
          </div>
          <div class="row">
                    ...
                    <tb>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          href="app.php?page=create-blog&edit=<?php echo $row['id']?>
                          ">Edit</a>
