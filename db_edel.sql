...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2026 at 03:26 AM
...
(3, '6a74719f79990_pyhton.png', 'https://docs.google.com/document/d/1ujSY703SzFPF0j', 'Sistem Kasir ', 'Pengembangan sistem kasir menggunakan bahasa pemrograman pyhton', 1, '2026-08-06 11:35:59', '2026-08-07 01:25:28'),
(4, '6a7480ae55ca1_bmi2.jpg', 'https://drive.google.com/file/d/1E15jTCLUW72jrU7J_', 'Kalkulator BMI', 'Pengembangan Kalkulator Kesehatan Implementasi Java oop mengggunakan netbeans', 1, '2026-08-06 11:38:23', '2026-08-07 01:25:18'),
(5, '6a747d8f128fd_Picture1.png', 'https://drive.google.com/file/d/10VN7Z4eLADy36wDBG', 'APLIKASI ARRAY DINAMIS: APLIKASI RESERVASI KAMAR HOTEL', 'Project UAS struktur data yang mengimplementasikan array 1,2 dan 3 dimensi', 1, '2026-08-06 12:26:55', '2026-08-07 01:25:01');
...
CREATE TABLE `schools` (
  `id` int(11) NOT NULL,
  `title` varchar(50) NOT NULL,
  `substitle` varchar(50) DEFAULT NULL,
...
INSERT INTO `schools` (`id`, `title`, `substitle`, `year_start`, `year_end`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'SMA Wijaya Jakarta', 'IPA', '2021', '2024', 1, '2026-08-07 00:59:03', NULL),
(2, 'Universitas Bina Sarana Informatika', 'Prodi Informatika', '2025', '2029', 1, '2026-08-07 01:00:04', NULL);
...
(1, 'Dealova Edelweiss', 'dealovaedelweissss@gmail.com', '085892089968', 'Sunter, Jakarta Utara, DKI Jakarta', 'Mahasiswa Informatika semester 3 di UBSI yang sedang fokus mendalami web programming. Memadukan logika IT, pengalaman mengurus organisasi, dan kecintaan pada dunia visual untuk membangun website yang bagus', 'edlnoirss', '2026-07-30 02:50:26', '2026-08-07 01:23:09');
