...
if($id){
  //query update
  $update = mysqli_query($conn, "UPDATE contacts SET name ='$name', email ='$email', subject = 'subject', message = '$message WHERE id='$id'");
      ...
      <div class="container">
        <div class="page-inner">
          <div
            ...
            <div>
              <h3 class="fw-bold mb-3"><?php echo isset($_GET['edit'])? 'Edit Contact' : 'Create New Contact' ?></h3>
